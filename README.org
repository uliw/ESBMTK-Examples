...
This directory contains the ESBMTK implementation of the Boudreau et al. 2010 model see https://doi.org/10.1029/2009gb003654 
  - =model_walkthrough.ipynb= is Jupyter Notebook explaining the model setup. Ii is also available online as an interactive [[https://mybinder.org/v2/gh/uliw/ESBMTK-Examples/main?labpath=%2FBoudreau_2010%2Fmodel_walkthrough.ipynb][Jupyter Notebook via Binder]]. 
